...
var $author$project$Main$Station = F4(
	function (name, stream, thumbnail, categories) {
		return {categories: categories, name: name, stream: stream, thumbnail: thumbnail};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$map4 = _Json_map4;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$stationDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Main$Station,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'stream', $elm$json$Json$Decode$string),
